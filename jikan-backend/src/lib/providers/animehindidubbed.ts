...
export async function getAnimeHindiDubbedInfo(
  id: string,
): Promise<{
  id: any;
  title: any;
  ...
  try {
    ...
    if (match && match.index !== undefined) {
      try {
        ...
        console.log(
          "[AnimeHindiDubbed] Raw match preview:",
        ...
        console.log(
          "[AnimeHindiDubbed] Cleaned JSON string length:",
          jsonStr.length,
        );
        console.log(
          "[AnimeHindiDubbed] Cleaned JSON preview:",
        ...
        try {
          ...
          console.error(
            "[AnimeHindiDubbed] Problematic JSON snippet:",
...
export async function getAnimeHindiDubbedSources(
  id: string,
  episodeName: string,
) {
  try {
    ...
    let episode = info.episodes.find(
      (ep: any) =>
