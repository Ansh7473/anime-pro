...
export async function searchAnimelok(query) {
    try {
...
export async function getAnimelokMetadata(slug) {
    let allEpisodes = [];
    let page = 0;
    const pageSize = 250;
    try {
...
export async function getAnimelokSources(slug, ep) {
    try {
...
//# sourceMappingURL=animelok.js.map